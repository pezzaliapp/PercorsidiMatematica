const CACHE='percorsi-math-v6-3d';const ASSETS=['index.html','style.css','app.js','readme.html','indicazioni.html','manifest.json','icons/icon-192.png','icons/icon-512.png'];
